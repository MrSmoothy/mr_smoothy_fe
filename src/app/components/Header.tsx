      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 py-3 sm:py-4">
        <Link href="/" className="flex items-center gap-2 sm:gap-3 hover:opacity-90 transition-opacity">
          ...
          <div className="flex flex-col">
            <span className="text-xl sm:text-2xl font-bold text-[#E8DDCB] leading-tight font-serif">Mr.Smoothy</span>
          </div>
        </Link>
        ...
        <nav className="hidden lg:flex items-center gap-4">
          ...
          <div className="relative">
            ...
            >
              {pathname === '/cart' || pathname?.startsWith('/cart/') ? (
                <ShoppingCart 
                  className="w-5 h-5 sm:w-6 sm:h-6 text-[#4A3728] flex-shrink-0"
                  strokeWidth={2}
                />
              ) : (
                <ShoppingCart 
                  className="w-5 h-5 sm:w-6 sm:h-6 text-[#E8DDCB] flex-shrink-0"
                  strokeWidth={2}
                />
              )}
              {cartCount > 0 && (
          ...
          {user ? (
            <div className="relative" ref={userMenuRef}>
              <button
                ...
                className="flex items-center gap-2 px-3 sm:px-4 py-2 rounded-lg bg-[#E8DDCB]/10 hover:bg-[#E8DDCB]/20 transition-colors"
              >
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[#E8DDCB] flex items-center justify-center">
                  <UserCircle className="w-4 h-4 sm:w-5 sm:h-5 text-[#4A3728]" />
                </div>
                <span className="text-[#E8DDCB] font-medium font-sans hidden xl:inline">{user.fullName || user.username}</span>
        ...
        <div className="flex lg:hidden items-center gap-2">
          <Link
            href="/cart"
            className={`relative p-2 rounded transition-all inline-flex items-center justify-center ${
              pathname === '/cart' || pathname?.startsWith('/cart/')
                ? 'bg-[#E8DDCB]' 
                : 'hover:bg-[#E8DDCB]/20'
            }`}
          ...
          <button
            ...
            className="p-2 text-[#E8DDCB] hover:bg-[#E8DDCB]/20 rounded transition-colors"
        ...
        <div className="lg:hidden border-t border-[#E8DDCB]/20 bg-[#4A3728]">
          <nav className="px-4 py-4 space-y-2">
            <Link
              ...
              className={`block px-4 py-3 rounded transition-all font-medium ${
                pathname === '/' 
                  ? 'bg-[#E8DDCB] text-[#4A3728] font-semibold' 
