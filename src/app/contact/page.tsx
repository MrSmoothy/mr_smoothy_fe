      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-6 sm:py-8 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-12">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#4A3728] mb-1 font-sans">เบอร์โทรศัพท์</h3>
                  <a href={`tel:${shopInfo.phone}`} className="text-[#4A3728]/70 hover:text-[#4A3728] transition-colors font-sans">
                    {shopInfo.phone}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#4A3728] mb-1 font-sans">อีเมล</h3>
                  <a href={`mailto:${shopInfo.email}`} className="text-[#4A3728]/70 hover:text-[#4A3728] transition-colors font-sans">
                    {shopInfo.email}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#4A3728] mb-1 font-sans">ที่ตั้งร้าน</h3>
                  <p className="text-[#4A3728]/70 font-sans mb-1">{shopInfo.fullAddress}</p>
                  <p className="text-[#4A3728]/70 font-sans">{shopInfo.address}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#4A3728] mb-1 font-sans">เวลาเปิด-ปิด</h3>
                  <p className="text-[#4A3728]/70 font-sans">
              ...
              <div className="flex items-start gap-4 pt-4">
                <div className="w-12 h-12 rounded-full bg-[#E8DDCB] flex items-center justify-center flex-shrink-0">
                  <Facebook className="w-6 h-6 text-[#4A3728]" />
                </div>
                <div className="flex-1">
                  <h3 className="font-semibold text-[#4A3728] mb-3 font-sans">ติดตามเราบน</h3>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <h2 className="text-2xl font-bold text-[#4A3728] p-8 pb-4 font-serif">แผนที่</h2>
            {isClient && (
            ...
            <div className="p-4 bg-[#F5EFE6]">
              <a
                href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(shopInfo.fullAddress)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-[#4A3728] hover:text-[#4A3728]/70 font-sans text-center block underline transition-colors"
              >
                เปิดใน Google Maps →
              </a>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-[#4A3728] mb-6 text-center font-serif">Partner</h2>
          <p className="text-[#4A3728]/70 text-center mb-8 font-sans">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {partners.map((partner, index) => (
              <div 
                key={index}
                className="flex flex-col items-center justify-center p-6 bg-[#F5EFE6] rounded-lg hover:bg-[#E8DDCB] transition-colors"
              >
                <img 
                  src={partner.logo} 
                  alt={partner.name}
                ...
                />
                <span className="text-[#4A3728] font-semibold font-sans text-center text-sm">{partner.name}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* ข้อมูลเพิ่มเติม */}
        <div className="bg-[#4A3728] rounded-lg shadow-lg p-8 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div>
              ...
              <p className="text-[#E8DDCB]/80 text-sm font-sans">
